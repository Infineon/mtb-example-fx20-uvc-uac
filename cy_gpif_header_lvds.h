...
uint16_t cy_lvds_gpif_transition0[] = {0x0000, 0x5555, 0x8888, 0x7777, 0xAAAA, 0xF0F0};

uint8_t cy_lvds_gpif_wavedata_position0[] = {0, 1, 0, 2, 0};
...
const cy_stc_lvds_gpif_wavedata_t cy_lvds_gpif_wavedata1[] = {
...
uint16_t cy_lvds_gpif_transition1[] = {0x0000, 0x8888, 0x5555};

uint8_t cy_lvds_gpif_wavedata_position1[] = {0, 1, 0};

const cy_stc_lvds_gpif_reg_data_t cy_lvds_gpif_reg_data1[] = {
...
/* Pushing data into Thread 0 Socket */
const cy_stc_lvds_gpif_config_t cy_lvds_gpif_config_th3_socket = {
    (uint16_t)(sizeof(cy_lvds_gpif_wavedata_position1)/sizeof(uint8_t)),
    (cy_stc_lvds_gpif_wavedata_t *) cy_lvds_gpif_wavedata1,
    cy_lvds_gpif_wavedata_position1,
    (uint16_t)(sizeof(cy_lvds_gpif_transition1)/sizeof(uint16_t)),
    cy_lvds_gpif_transition1,
    (uint16_t)(sizeof(cy_lvds_gpif_reg_data1)/sizeof(cy_stc_lvds_gpif_reg_data_t)),
    (cy_stc_lvds_gpif_reg_data_t *) cy_lvds_gpif_reg_data1
};

/* LVDS configuration output generated by Device Configurator */
cy_stc_lvds_phy_config_t LVDS1_config =
{
    .loopbackModeEn      = true,
    .isPutLoopbackMode   = false,
    .wideLink            = 0u,
